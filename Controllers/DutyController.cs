...
namespace DormitoryManagement.Controllers
{
    public class DutyController : Controller
    {
        ...
        public void sign_in_stranger(string p_id,string name,string in_time,string out_time,string type)
        {
            if (p_id != null)
            {
        ...
        public void sign_in_late_student(string p_id,string name,string in_time,string type)
        {
            if (p_id!= null)
            {
